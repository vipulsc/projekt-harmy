...
function SignUpBox() {
  return (
    <div className="flex justify-center items-center h-full w-full">
      <SignUp redirectUrl="/" signInUrl="/sign-in" path="/sign-up" />
    </div>
  );
}
    ...
    <>
        ...
        <div className="w-3/5 bg-[var(--color-sign-in-bg)]  flex flex-col justify-between px-16 py-24">
          ...
          <div className="flex-1 flex flex-col justify-center max-w-lg">
            ...
            >
              ...
              <p className="text-xl leading-relaxed">
                Unlock your potential with structured roadmaps, curated video
                resources, and real progress tracking.
              </p>
            </motion.div>
          </div>
          ...
          <div className="flex flex-col space-y-4">
            <div className="flex space-x-6">
              <Link
                href="https://twitter.com/path_blaze"
                className="group"
      ...
      <div className="md:hidden flex flex-col h-screen bg-[var(--color-sign-in-bg)] relative">
        ...
        <div className="flex items-center justify-center pt-8 pb-4 mt-8">
          <span className="text-2xl font-bold text-accent">harmY</span>
        </div>
